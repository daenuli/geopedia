...
<div class="login-box">
  <div class="login-logo">
    <a href="javascript:void(0)"><b>Geopedia</b></a>
  </div>
  @if ($errors->any())
  ...
  <div class="login-box-body">
    ...
    <div class="social-auth-links text-center">
      <p>- OR -</p>
      <a href="{{url('login/github')}}" class="btn btn-block btn-social btn-github btn-flat"><i class="fa fa-github"></i> Sign in using
        Github</a>
